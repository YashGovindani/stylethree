...
if(employeeDAO.panNumberExists(employeeDTO.getPANNumber())) errorString+=",panNumber,PAN number exists";
if(employeeDAO.aadharCardNumberExists(employeeDTO.getAadharCardNumber())) errorString+=",aadharCardNumber,Aadhar card number exists";
